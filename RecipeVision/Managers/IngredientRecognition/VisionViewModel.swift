...
//    }
//    
//    private var progress: Binding<CGFloat>? = nil
//    
////    @Published var recognitionInProgress: Bool = false {
////        didSet {
////            print("recognitionInProgress in visionModel set to: \(recognitionInProgress)")
////        }
////    }
//    
//    public func performImageToTextRecognition(on image: UIImage,
